...
//
// Description : Array and textureless GLSL 2D/3D/4D simp
//      A thor : Ian McEwan, As
//  Maint iner : ijm
//     La tmod : 20110822 (ijm
//      icens  : Cop
//
//               https:
//
...
void main() {
    ...
    vec3 noise = curlNoise(vec3(pos.x * uCnoise.x + time * 0.05, pos.y * uCnoise.y + time * 0.05, (pos.x + pos.y) * uCnoise.z));
