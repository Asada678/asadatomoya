  ...
  return (
    <section>
      ...
      <div className="max-w-3xl px-2">
        {profile.map((p, i) => (
          <div className="items-center gap-4 border-b pb-2 pt-4 md:flex md:py-4" key={i}>
            <h3 className="mb-1 md:mb-0 w-36 md:w-48">{p.title}</h3>
            <p className="font-16-20 font-bold">{p.value}</p>
          </div>
        ))}
      </div>
    </section>
