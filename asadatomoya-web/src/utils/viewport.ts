...
//     far?: number
//   ) => Viewport;
//   addResizeAction: (callback: (viewport: Viewport) => void) => void;
//   removeResizeAction: (callback: (viewport: Viewport) => void) => void;
//   isMobile: () => boolean;
//   width?: number;
//   height?: number;
//   near?: number;
...
// function init(canvas : any, cameraZ = 2000, near = 1500, far = 4000) {
//   $.canvas = canvas;
